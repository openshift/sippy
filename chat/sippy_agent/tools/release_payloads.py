...
class SippyReleasePayloadTool(SippyBaseTool):
    ...
    class ReleasePayloadInput(SippyToolInput):
        ...
        include_ready: Optional[bool] = Field(default=False, description="Include 'Ready' phase payloads (defaults to False)")
        limit: Optional[int] = Field(default=10, description="Maximum number of payloads to return (defaults to 10)")
