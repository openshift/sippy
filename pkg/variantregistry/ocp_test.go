	...
	tests := []struct {
		...
		},
		{
			...
			expected: map[string]string{
				...
				VariantContainerRuntime: "crun",
				VariantCGroupMode:       "v2",
				VariantLayeredProduct:   "lp-interop--acm-virt",
				VariantOS:               "rhcos9",
			},
		},
		{
		...
		},
		{
			...
			expected: map[string]string{
				...
				VariantContainerRuntime: "crun",
				VariantCGroupMode:       "v2",
				VariantLayeredProduct:   "lp-interop--OPP",
				VariantOS:               "rhcos9",
			},
		},
		{
		...
		{
			job: "periodic-ci-rhobs-troubleshooting-scenarios-main-4.22-ols-eval-openai-periodics",
			expected: map[string]string{
				VariantRelease:          "4.22",
				VariantReleaseMajor:     "4",
				VariantReleaseMinor:     "22",
		...
		{
			job: "periodic-ci-rhobs-troubleshooting-scenarios-main-4.22-agentic-eval-openai-periodics",
			expected: map[string]string{
				VariantRelease:          "4.22",
				VariantReleaseMajor:     "4",
				VariantReleaseMinor:     "22",
