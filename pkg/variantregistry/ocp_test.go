...
func TestVariantSyncer(t *testing.T) {
	...
	tests := []struct {
		...
		{
			job:          "periodic-ci-redhat-chaos-lp-chaos-main-ocp-5.1-ocp-chaos-cr--outage-node--aws",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "5.1",
				VariantReleaseMajor:     "5",
		...
		{
			job:          "periodic-ci-redhat-chaos-lp-chaos-main-ocp-5.1-ocp-chaos-cr--outage-pod--aws",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "5.1",
				VariantReleaseMajor:     "5",
		...
		{
			job: "periodic-ci-openshift-hypershift-release-5.0-periodics-e2e-aws-ovn-conformance-techpreview",
			expected: map[string]string{
				VariantRelease:          "5.0",
				VariantReleaseMajor:     "5",
				VariantReleaseMinor:     "0",
		...
		{
			job: "periodic-ci-openshift-hypershift-release-5.0-periodics-e2e-v2-aws",
			expected: map[string]string{
				VariantRelease:          "5.0",
				VariantReleaseMajor:     "5",
				VariantReleaseMinor:     "0",
		...
		{
			job: "periodic-ci-openshift-hypershift-release-5.0-periodics-e2e-v2-aws-backuprestore",
			expected: map[string]string{
				VariantRelease:          "5.0",
				VariantReleaseMajor:     "5",
				VariantReleaseMinor:     "0",
		...
		{
			job:          "periodic-ci-RedHatQE-interop-testing-master-ocp-4.22-lpMainline-lp-interop--acm-virt--p2p-cr--n1-upgrade--aws",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "4.22",
				VariantReleaseMajor:     "4",
				...
				VariantContainerRuntime: "crun",
				VariantCGroupMode:       "v2",
				VariantLayeredProduct:   "lp-interop--acm-virt--lpMainline",
				VariantOS:               "rhcos9",
			},
		},
		{
			job:          "periodic-ci-RedHatQE-interop-testing-master-ocp-4.22-lpMainline-lp-interop--acm-virt--cclm-cr--2spoke-mig--aws",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "4.22",
				VariantReleaseMajor:     "4",
		...
		},
		{
			...
			expected: map[string]string{
				...
				VariantContainerRuntime: "crun",
				VariantCGroupMode:       "v2",
				VariantLayeredProduct:   "lp-interop--opp--lpMainline",
				VariantOS:               "rhcos9",
			},
		},
		{
		...
		{
			job:          "periodic-ci-RedHatQE-interop-testing-master-opp--ocp-4.22-lpMainline-lp-interop-cr--full-stack--aws",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "4.22",
				VariantReleaseMajor:     "4",
		...
		{
			job:          "periodic-ci-RedHatQE-interop-testing-master-opp--ocp-5.0-lpMainline-lp-interop-cr--full-stack--vsphere",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "5.0",
				VariantReleaseMajor:     "5",
		...
		{
			job:          "periodic-ci-RedHatQE-interop-testing-master-ocp-4.22-lpMainline-lp-interop--opp-cr--full-stack--aws",
			variantsFile: map[string]string{},
			expected: map[string]string{
				VariantRelease:          "4.22",
				VariantReleaseMajor:     "4",
		...
		{
			job: "periodic-ci-openshift-release-main-nightly-5.0-e2e-aws-disruptive-longrunning-techpreview-1of2",
			expected: map[string]string{
				VariantRelease:          "5.0",
				VariantReleaseMajor:     "5",
				VariantReleaseMinor:     "0",
		...
		},
		{
			...
			expected: map[string]string{
				...
				VariantLayeredProduct:   VariantNoValue,
				VariantOS:               "rhcos9",
				VariantComponent:        "Node / Kubelet",
				VariantCapability:       "CPU Partitioning",
			},
		},
		{
			...
			expected: map[string]string{
				...
				VariantLayeredProduct:   VariantNoValue,
				VariantOS:               "rhcos9",
				VariantComponent:        "Etcd",
				VariantCapability:       "Scaling",
			},
		},
		{
			job: "periodic-ci-openshift-release-master-nightly-5.0-e2e-aws-ovn-installer-dualstack-ipv4-primary-techpreview",
			expected: map[string]string{
				VariantRelease:          "5.0",
				VariantReleaseMajor:     "5",
				VariantReleaseMinor:     "0",
