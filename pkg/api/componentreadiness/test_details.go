...
func (c *componentReportGenerator) GenerateTestDetailsReport(ctx context.Context) (crtype.ReportTestDetails, []error) {
	...
	if c.BaseOverrideRelease.Release != "" && c.BaseOverrideRelease.Release != c.BaseRelease.Release {
		...
		overrideReport := c.internalGenerateTestDetailsReport(ctx, componentJobRunTestReportStatus.BaseOverrideStatus, c.BaseOverrideRelease.Release, overrideSampleStatus)
	...
	report := c.internalGenerateTestDetailsReport(ctx, componentJobRunTestReportStatus.BaseStatus, c.BaseRelease.Release, componentJobRunTestReportStatus.SampleStatus)
...
func (c *componentReportGenerator) internalGenerateTestDetailsReport(ctx context.Context, baseStatus map[string][]crtype.JobRunTestStatusRow, baseRelease string,
