...
func (p *PostgresProvider) QuerySpotCheckJobRuns(_ context.Context, _ reqopts.RequestOptions,
	_ crtest.JobVariants, _ []string, _, _ time.Time) ([]dataprovider.SpotCheckGroup, error) {
	return nil, nil
}

func (p *PostgresProvider) QuerySpotCheckJobRunDetails(_ context.Context, _ reqopts.RequestOptions,
	_ crtest.JobVariants, _ map[string]string, _ []string, _, _ time.Time) ([]dataprovider.JobRunDetail, error) {
	return nil, nil
}
