...
func TestDateTimeNameComparisons(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "plain cluster data only",
			names:          []string{`artifacts/e2e-metal/cluster-data.json`},
			expectedResult: `artifacts/e2e-metal/cluster-data.json`,
		},
		{
			name:           "timestamped cluster data only",
			names:          []string{`artifacts/e2e-metal/cluster-data_20260915-120000.json`},
			expectedResult: `artifacts/e2e-metal/cluster-data_20260915-120000.json`,
		},
		{
			name: "plain and timestamped cluster data",
			names: []string{
				`artifacts/e2e-metal/cluster-data.json`,
				`artifacts/e2e-metal/cluster-data_20260915-120000.json`,
			},
			expectedResult: `artifacts/e2e-metal/cluster-data_20260915-120000.json`,
		},
		{
