...
func (ocp *OCPProject) GetProductDomain() (product, domain string) {
	return "OCP", "ocp.releases.ci.openshift.org"
}
...
func (okd *OKDProject) GetProductDomain() (product, domain string) {
	return "OKD", "origin.releases.ci.openshift.org"
}
