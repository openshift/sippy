...
type PayloadProject interface {
	...
	// GetProductDomain returns the Product to match from the Releases table as well as the r-c domain for this project
	GetProductDomain() (product, domain string)
