...
--   - variant_cumulative_summaries (prefix sums grouped by variant_combination_id)
--
...
-- ============================================================================
-- 3. variant_cumulative_summaries
-- ============================================================================

CREATE TABLE IF NOT EXISTS variant_cumulative_summaries (
    date DATE NOT NULL,
    release TEXT NOT NULL,
    test_id BIGINT NOT NULL,
    suite_id BIGINT NOT NULL DEFAULT 0,
    ...
    PRIMARY KEY (date, release, test_id, suite_id, variant_combination_id)
) PARTITION BY LIST (release);
