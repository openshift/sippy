...
while [ true ]; do
  ...
  /bin/sippy --log-level debug --load-database --local-data /data --skip-bug-lookup --arch amd64 --arch arm64 --arch s390x --arch ppc64le --release 3.11 --release 4.6 --release 4.7 --release 4.8 --release 4.9 --release 4.10 --release 4.11
