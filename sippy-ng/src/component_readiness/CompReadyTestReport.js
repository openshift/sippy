...
export default function CompReadyTestReport(props) {
  ...
  const defaultTestReport = generateTestReport(
    testId,
  ...
  if (
    ...
    isBaseOverride = true
    overrideAssessmentIcon = getStatusAndIcon(
      data.base_override_report.status
    )[1]
  }
        ...
        <TableBody>
          ...
          {isBaseOverride ? (
            <TableRow>
              ...
              <TableCell>
                <Link to={defaultTestReport}>
                  <Tooltip
                    title="Click to see original
            basis comparison"
                  >
                    {overrideAssessmentIcon}
                  </Tooltip>
                </Link>
              </TableCell>
            </TableRow>
